...
class LaCTSWIGLULayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Check dtype for FlashAttention compatibility
        ...
        if q.dtype not in allowed_dtypes or k.dtype not in allowed_dtypes or v.dtype not in allowed_dtypes:
            raise RuntimeError(f"FlashAttention only supports fp16 and bf16 data types, but got q: {q.dtype}, k: {k.dtype}, v: {v.dtype}. Please cast your input tensors to fp16 or bf16 before using this layer.")
